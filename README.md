...
The optional [0.2.1-dev.3 prerelease](https://github.com/bishopdynamics/aviadilo/releases/tag/v0.2.1-dev.3) adds automatic recovery for temporary tile failures, improved sharing across kiosks and up to one hour of recent-view basemap reuse. It also prioritizes independent household icons at their true locations and makes relocation connectors easier to see. See the [prerelease instructions](docs/user-guide.md#optional-tile-streaming-prerelease) to test it.
