...
Aviadilo contains the first five slices: bootstrap, HA integration foundations, authenticated transport, the map/editor/household-tracker layer, and aircraft collection/presentation components. The fixture harness exercises the map, editor and traveller filtering offline. Aircraft frontend composition remains slice 8; radar and wind providers/rendering follow in slices 6 and 7.
