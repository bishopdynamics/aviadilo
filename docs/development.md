...
Aviadilo contains the first six slices: bootstrap, HA integration foundations, authenticated transport, the map/editor/household-tracker layer, aircraft collection/presentation, and selected radar adapters/playback. The fixture harness exercises the map, editor and traveller filtering offline. Aircraft/radar frontend composition remains slice 8; DWD wind follows in slice 7.
