...
1. [in-progress] Implement `docs/spec/ROOT_SPEC.md` — approved 2026-09-06; slice 1 started 2026-09-06.
   ...
   - Paused at the normal slice handoff. Next approved slice: 7, DWD wind and local animation. Accepted scope/decisions do not need renewed approval; wait for user continuation before the next slice.
