...
1. [in-progress] Implement `docs/spec/ROOT_SPEC.md` — approved 2026-09-06; slice 1 started 2026-09-06.
   ...
   - Pause at the slice handoff. Next: slice 3, authenticated WebSocket/HTTP protocol and frontend client, with both ends owned by one worker. Accepted scope/decisions do not need renewed approval.
